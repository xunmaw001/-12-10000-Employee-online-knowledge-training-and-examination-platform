...
public class ChengjishensuController {
    ...
    public R page(@RequestParam Map<String, Object> params,ChengjishensuEntity chengjishensu, 
		...
		if(tableName.equals("jiaoshi")) {
			chengjishensu.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yuangong")) {
			chengjishensu.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
