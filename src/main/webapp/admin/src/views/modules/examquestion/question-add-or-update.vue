<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="选择考试" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择考试">
          <el-option
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择考试", trigger: "blur" }],
        questionname: [
