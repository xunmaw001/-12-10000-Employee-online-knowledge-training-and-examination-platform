    ...
    <div v-if="!showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-form-item label="考试名称">
          <el-input v-model="searchForm.name" placeholder="考试名称" clearable></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <div class="table-content">
        ...
        >
          ...
          <el-table-column prop="name" header-align="center" align="center" sortable label="考试"></el-table-column>
          <el-table-column
            prop="time"
            header-align="center"
            align="center"
          ...
          <!-- <el-table-column prop="status" header-align="center" align="center" sortable label="考试状态">
