  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">教师职称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshizhicheng" class="input" type="text" placeholder="教师职称">
			   </div>
			 </div> -->
			<el-form-item label="教师职称" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshizhicheng" autocomplete="off" placeholder="教师职称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
